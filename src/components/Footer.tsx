      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-2xl font-bold mb-4">Guduri VenuSree</h3>
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <a href="https://github.com/GuduriVenuSree5" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-all duration-300">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/in/venusree" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-all duration-300">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:2200031051cseh@gmail.com" className="p-2 bg-white/10 rounded-lg hover:bg-white/20 transition-all duration-300">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-start">
                ...
                <span className="text-blue-200">8121913956</span>
              </div>
              <div className="flex items-center gap-3 justify-center md:justify-start">
                <MapPin className="w-4 h-4 text-blue-400" />
                <span className="text-blue-200">Tiruvuru, Andhra Pradesh</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center">
          <p className="text-blue-200 flex items-center justify-center gap-2 mb-2">
